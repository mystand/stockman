...
Stockman is an opensource standalone image processoring server with frontend libraries. It was made for help you in your working with images 
...
```
* `PROJECT_PRIVATE_KEY` - private key of the project
* `IMAGE_PRIVATE_KEY` - private key of the image
...
| versions | Optional params for some image versions (look detail description below) | Hash |

Description of the versions params
You can specify processing options for some 
